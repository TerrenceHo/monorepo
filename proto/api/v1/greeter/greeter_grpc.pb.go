...
const (
	GreeterService_SayHello_FullMethodName       = "/myorg.api.v1.greeter.GreeterService/SayHello"
	GreeterService_SayHelloStream_FullMethodName = "/myorg.api.v1.greeter.GreeterService/SayHelloStream"
)
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "myorg.api.v1.greeter.GreeterService",
	...
	Metadata: "proto/api/v1/greeter/greeter.proto",
}
